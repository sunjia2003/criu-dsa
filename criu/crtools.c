...
usage:
	...
	pr_msg("\n"
	       ...
	       "  --workspace-snapshot  enable workspace btrfs snapshot during dump\n"
	       "  --workspace-root PATH source workspace root to snapshot\n"
	       "  --workspace-snapshot-parent PATH\n"
	       "                        parent directory for snapshots (must be outside source)\n"
	       "  --workspace-snapshot-dir NAME\n"
	       "                        subdir under snapshot parent for snapshot subvolumes\n"
	       "                        (default: snaps)\n"
	       "  --workspace-snapshot-meta-dir NAME\n"
	       "                        subdir under snapshot parent for snapshot metadata\n"
	       "                        (default: meta)\n"
	       "  --workspace-snapshot-strict\n"
	       "                        fail dump if source workspace contains nested subvolumes\n"
